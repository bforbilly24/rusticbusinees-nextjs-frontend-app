			...
			<div className='container max-lg:max-w-full fixed-lg:pr-0'>
				<div className='lg:grid lg:grid-cols-2 max-md:flex max-md:flex-col-reverse'>
					<div className='about-content max-md:pt-10'>
						...
						<p className={desc}>
							Founded by Robert Downey Jr in 2004, we’re an employee-owned firm pursuing a democratic design process that values everyone’s input. Today we have more than 150 people in London, Hong Kong and Sydney providing architecture, interior & urban design services from concept to
							completion.
						</p>
						<Link href='/about'>
					...
					<div className={aboutImage}>
						<Image src='/images/about/1.jpg' alt='Service Image' width={390} height={760} quality={70} layout='fixed' objectFit='cover' priority />
					</div>
				</div>
			</div>
		</div>
