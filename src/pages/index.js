...
function HomePage({ heroItems, services, projects, pricingItems, testimonialItems, brandItems, posts }) {
	return (
		<>
			<Head>
				<title>Rustic - React Business Template</title>
				<meta name='description' content='Rustic - React Business Template is an excellent solution to the web designing needs for your website related to creative agency, business, portfolio, corporate, etc. ' />
			</Head>
			<HeaderOne />
			...
			<Testimonial testimonialItems={testimonialItems} testimonialTitle='+1,250 Happy Clients' />
